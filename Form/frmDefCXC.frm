...
Begin VB.Form frmDefCXC 
   Appearance      =   0  'Flat
   BackColor       =   &H00DDDDDD&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Definición de Cuentas por Cobrar"
   ClientHeight    =   2535
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   3615
...
Private Sub cmbAceptar_Click()
    ...
    strSql = " UPDATE parametro " & _
             ...
             " WHERE par_codigo='CXC' AND emp_codigo='" & strEmpresa & "'"
