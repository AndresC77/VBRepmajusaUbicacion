...
Begin VB.Form frmPerCtaBancaria 
   BackColor       =   &H00DDDDDD&
   ...
   ClientTop       =   330
   ClientWidth     =   8880
   Icon            =   "frmPerCtaBancaria.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmPerCtaBancaria.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmPerCtaBancaria"
...
Private Sub Carga()
    ...
    strSql = " SELECT ban_codigo,per_cue_numero,per_cue_tipo,per_cue_fechamod, per_cue_usumod, '0' as modi" & _
    ...
    strSql = " SELECT ban_codigo,ban_nombre " & _
             ...
             " ORDER BY ban_nombre"
    clsCon_Def.Ejecutar strSql
    VSFG.ColComboList(1) = VSFG.BuildComboList(clsCon_Def.adorec_Def, "ban_codigo,*ban_nombre", "ban_codigo")
    VSFG.ColComboList(3) = "|#CTE;CORRIENTE|#AHO;AHORROS"
...
Private Sub cmbAceptar_Click()
    ...
    For i = 1 To VSFG.Rows - 1
        If FormatoD0(VSFG.TextMatrix(i, VSFG.Cols - 1)) <> 1 Then
             strSql = " INSERT INTO persona_cuenta " & _
                      " (emp_codigo,per_codigo,ban_codigo,per_cue_numero,per_cue_tipo,per_cue_fechamod,per_cue_usumod) " & _
                      " VALUES ('" & strEmpresa & "','" & CodPer & "','" & VSFG.TextMatrix(i, 1) & "','" & VSFG.TextMatrix(i, 2) & "','" & VSFG.TextMatrix(i, 3) & "'," & _
