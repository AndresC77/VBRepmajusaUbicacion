...
Begin VB.Form frmV_VerRangoComi 
   BackColor       =   &H00DDDDDD&
   ...
   ClientTop       =   330
   ClientWidth     =   6060
   Icon            =   "frmV_VerRangoComi.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFG 
         ...
         FormatString    =   $"frmV_VerRangoComi.frx":030A
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFGm 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmV_VerRangoComi.frx":0394
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmV_VerRangoComi"
...
Private Sub Command1_Click()
    frmConstruccionCalculoRedes.Show
End Sub
...
Private Sub cmdModificar_Click()
    frmV_RangoComi.Tag = "M"
    frmV_RangoComi.lonCod = VSFGm.TextMatrix(VSFGm.Row, 0)
    frmV_RangoComi.DTPicker1.Value = VSFGm.TextMatrix(VSFGm.Row, 1)
    frmV_RangoComi.DTPicker2.Value = VSFGm.TextMatrix(VSFGm.Row, 2)
    frmV_RangoComi.chkActivo.Value = VSFGm.TextMatrix(VSFGm.Row, 3)
    frmV_RangoComi.Show
End Sub

Private Sub cmdNuevo_Click()
    frmV_RangoComi.Tag = "N"
    frmV_RangoComi.Show
End Sub
