...
Begin VB.Form frmV_RangoComi3 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFG 
         ...
         FormatString    =   $"frmV_RangoComi3.frx":030A
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Image imgBtnDn 
         Height          =   210
         Left            =   360
         Picture         =   "frmV_RangoComi3.frx":03A9
         Top             =   2520
         Visible         =   0   'False
         Width           =   225
      End
      Begin VB.Image imgBtnUp 
         Height          =   210
         Left            =   120
         Picture         =   "frmV_RangoComi3.frx":04D5
   ...
   End
End
Attribute VB_Name = "frmV_RangoComi3"
...
Private Sub cmdAceptar_Click()
    ...
    Else
        ...
        clsSql.Ejecutar strSql, "M"
    End If
    strSql = " INSERT INTO rango_comi3 (emp_codigo,ran_com_codigo,ran_com_fecha,ran_com_fechafin,ran_com_activo,ran_com_porcentaje,ran_com_fechamod,ran_com_usumod)" & _
             " VALUES('" & strEmpresa & "','" & lonCod & "','" & DTPicker1.value & "','" & _
             DTPicker2.value & "','" & intAct & "', '" & txtCosto.Text & "' , CURRENT_TIMESTAMP,substring_index(USER(),'@',1))"
    clsSql.Ejecutar strSql, "M"
    For i = 1 To VSFG.Rows - 1
        strSql = " INSERT INTO det_rango_comi3 (emp_codigo,ran_com_codigo,det_com_ran_inferior,det_com_ran_superior,det_com_ran_porcentaje,det_com_ran_fechamod,det_com_ran_usumodmod)" & _
    ...
    Next i
    If intAct = 1 Then
        strSql = " UPDATE rango_comi3 SET " & _
                 " ran_com_fechafin='" & DTPicker1.value & _
                 "', ran_com_activo='0', ran_com_porcentaje='" & txtCosto.Text & "',ran_com_fechamod=CURRENT_TIMESTAMP,ran_com_usumod=substring_index(USER(),'@',1)" & _
...
Private Sub Form_Activate()
    If Me.Tag = "M" And VSFG.Rows < 3 Then
        ...
        VSFG.TextMatrix(1, 3) = frmV_VerRangoComi3.VSFG.TextMatrix(1, 2)
    End If
End Sub
