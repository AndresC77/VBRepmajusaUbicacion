...
Begin VB.Form frmAreaLaboral 
   BackColor       =   &H00DDDDDD&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Area Laboral"
   ClientHeight    =   6960
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8280
   Icon            =   "frmAreaLaboral.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmAreaLaboral.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmAreaLaboral"
...
End Sub
Private Sub Carga()
    strSql = " SELECT are_lab_codigo,are_lab_nombre,are_lab_fechamod, are_lab_usumod, '0' as modi " & _
             " FROM area_laboral " & _
             " WHERE emp_codigo = '" & strEmpresa & "'"
    If chkFiltroCodigo.value = 1 Then
        strSql = strSql & "AND  are_lab_codigo LIKE  '%" & txtCodigo.Text & "%'"
    End If
    If chkFiltroNombre.value = 1 Then
        strSql = strSql & " AND  are_lab_nombre LIKE '%" & txtNombre.Text & "%' "
    End If
    strSql = strSql & " ORDER BY are_lab_codigo,are_lab_nombre "
    ...
    For i = 1 To VSFG.Rows - 1
        ...
        If VSFG.TextMatrix(i, VSFG.Cols - 1) = 3 Then
            If Trim(VSFG.TextMatrix(i, 2)) = "" Then
                ...
                control = 1
            Else
           strSql = " UPDATE area_laboral " & _
                 " SET are_lab_nombre='" & UCase(Trim(VSFG.TextMatrix(i, 2))) & "'," & _
                 " are_lab_fechamod=CURRENT_TIMESTAMP," & _
                 " are_lab_usumod='" & strUsuario & "' " & _
                 " WHERE are_lab_codigo='" & VSFG.TextMatrix(i, 1) & "' " & _
        ...
        ElseIf VSFG.TextMatrix(i, VSFG.Cols - 1) = 2 Then
            ...
            Else
                ...
                If clsCon_Def.adorec_Def.RecordCount = 0 Then
                    ...
                    strSql = " INSERT INTO area_laboral(are_lab_codigo,emp_codigo,are_lab_nombre,are_lab_fechamod,are_lab_usumod) " & _
