...
Begin VB.Form frmCobrador 
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmCobrador.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Private Sub Carga()
    ...
    strSql = " SELECT cob_codigo, cob_nombre, cob_apellido, " & _
             " cob_fechamod, cob_usumod, '0' as modi" & _
             " From cobrador " & _
             " WHERE emp_codigo='" & strEmpresa & "' "
    
    If chkFiltroCodigo.Value = 1 Then
        strSql = strSql & "AND  cob_codigo LIKE  '%" & txtCodigo.Text & "%'"
    End If
    If chkFiltroNombre.Value = 1 Then
        strSql = strSql & " AND  (cob_apellido LIKE '%" & txtNombre.Text & "%' " & _
        " OR  cob_nombre LIKE '%" & txtNombre.Text & "%') "
    End If
    strSql = strSql & " ORDER BY cob_apellido,cob_nombre "
...
Private Sub cmbAceptar_Click()
    ...
    For i = 1 To VSFG.Rows - 1
        ...
        If VSFG.TextMatrix(i, VSFG.Cols - 1) = 3 Then
            strSql = " UPDATE cobrador SET " & _
                 " cob_nombre='" & UCase(VSFG.TextMatrix(i, 2)) & "', " & _
                 " cob_apellido='" & UCase(VSFG.TextMatrix(i, 3)) & "', " & _
                 " cob_fechamod=CURRENT_TIMESTAMP, " & _
                 " cob_usumod='" & strUsuario & "' " & _
                 " WHERE cob_codigo='" & VSFG.TextMatrix(i, 1) & "' " & _
        ...
        ElseIf VSFG.TextMatrix(i, VSFG.Cols - 1) = 2 Then
            ...
            Else
                ...
                If clsCon_Def.adorec_Def.RecordCount = 0 Then
                    strSql = " INSERT INTO cobrador " & _
                             " (cob_codigo, emp_codigo, cob_nombre, cob_apellido," & _
                             " cob_fechamod, cob_usumod ) " & _
