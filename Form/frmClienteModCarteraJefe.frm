...
Begin VB.Form frmClienteModCarteraJefe 
   BackColor       =   &H00DDDDDD&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Modificar Clientes (Jefe Cartera)"
   ClientHeight    =   7545
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12285
   Icon            =   "frmClienteModCarteraJefe.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmClienteModCarteraJefe.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Image imgBtnUp 
      Height          =   240
      Left            =   5760
      Picture         =   "frmClienteModCarteraJefe.frx":0905
   ...
   End
End
Attribute VB_Name = "frmClienteModCarteraJefe"
...
Private Sub Carga()
    strSql = " SELECT per_codigo,per_cm,per_rcm,per_tipo,per_apellido,per_nombre,cat_p_codigo,can_codigo,per_ruc,ciu_codigo,zon_codigo," & _
             ...
             " per_codigo_ref2,per_codigo_ref3,per_observacion,'' as datos,per_fac_flete,per_especial,IF(persona.per_bloqueado+persona.per_bloqueado_g=0,0,1) as per_bloqueado," & _
...
Private Sub VSFG_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    ...
    ElseIf Val(VSFG.TextMatrix(Row, VSFG.Cols - 1)) = 3 Or Val(VSFG.TextMatrix(Row, VSFG.Cols - 1)) = -3 Then
        If Not (Col = 21 Or Col = 23 Or Col = 29 Or Col = 33) Then
            Cancel = True
        End If
    End If
End Sub
