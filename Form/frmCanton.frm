...
Begin VB.Form frmCanton 
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmCanton.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
End Sub
Private Sub Carga()
    strSql = " SELECT can_codigo,can_nombre,can_fechamod, can_usumod, '0' as modi " & _
             " FROM canton " & _
             " WHERE can_codigo LIKE '%'"
        ...
        ElseIf VSFG.TextMatrix(i, VSFG.Cols - 1) = 2 Then
            ...
            Else
                ...
                If clsCon_Def.adorec_Def.RecordCount = 0 Then
                    strSql = " INSERT INTO canton(can_codigo,can_nombre,can_fechamod,can_usumod) " & _
