...
Private Sub cmbAceptar_Click()
    ...
    For i = 1 To VSFG.Rows - 1
        ...
        'controla que este lleno el número de comedor
            If VSFG.TextMatrix(i, 1) = "" Then
                MsgBox "No puede ingresar Centro de Costo falta el código", vbInformation, "Ingreso"
            ...
            Else
                ...
                'controla que no se repita el código de tipo de comida
            ...
            clsCon_Def.Ejecutar strSql, "M"
                Else
                    MsgBox "El código del Centro de Costo ya existe", vbInformation, "Ingreso"
                End If
            End If
        ElseIf VSFG.TextMatrix(i, VSFG.Cols - 1) = 1 Then
            ...
            If clsCon_Def.adorec_Def("existe") > 0 Then
                MsgBox "No puede eliminar el Centro de Costo", vbInformation, "Eliminación"
            Else
