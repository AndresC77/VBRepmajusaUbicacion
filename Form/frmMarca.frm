...
Begin VB.Form frmMarca 
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmMarca.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
End Sub
Private Sub Carga()
    strSql = " SELECT mar_codigo,mar_nombre,mar_descripcion,mar_fechamod, mar_usumod, '0' as modi " & _
             " FROM marca " & _
             " WHERE emp_codigo = '" & strEmpresa & "'"
    If chkFiltroCodigo.value = 1 Then
        strSql = strSql & "AND  mar_codigo LIKE  '%" & txtCodigo.Text & "%'"
    End If
    If chkFiltroNombre.value = 1 Then
        strSql = strSql & " AND  mar_nombre LIKE '%" & txtNombre.Text & "%' "
    End If
    strSql = strSql & " ORDER BY mar_nombre "
...
Private Sub cmbAceptar_Click()
    ...
    For i = 1 To VSFG.Rows - 1
        ...
        If VSFG.TextMatrix(i, VSFG.Cols - 1) = 3 Then
           strSql = " UPDATE marca " & _
                 " SET mar_nombre='" & UCase(VSFG.TextMatrix(i, 2)) & "'," & _
                 " mar_descripcion='" & UCase(VSFG.TextMatrix(i, 3)) & "'," & _
                 " mar_fechamod=CURRENT_TIMESTAMP," & _
                 " mar_usumod='" & strUsuario & "' " & _
                 " WHERE mar_codigo='" & VSFG.TextMatrix(i, 1) & "' " & _
        ...
        ElseIf VSFG.TextMatrix(i, VSFG.Cols - 1) = 2 Then
            ...
            Else
                ...
                If clsCon_Def.adorec_Def.RecordCount = 0 Then
                    strSql = " INSERT INTO marca(mar_codigo,emp_codigo,mar_nombre,mar_descripcion,mar_fechamod,mar_usumod) " & _
