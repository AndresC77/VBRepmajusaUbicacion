...
Begin VB.Form frmV_VerRangoComi2 
   BackColor       =   &H00DDDDDD&
   ...
   ClientTop       =   330
   ClientWidth     =   6060
   Icon            =   "frmV_VerRangoComi2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFG 
         ...
         FormatString    =   $"frmV_VerRangoComi2.frx":030A
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFGm 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmV_VerRangoComi2.frx":0394
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmV_VerRangoComi2"
...
Private Sub cmdModificar_Click()
    frmV_RangoComi2.Tag = "M"
    frmV_RangoComi2.lonCod = VSFGm.TextMatrix(VSFGm.Row, 0)
    frmV_RangoComi2.DTPicker1.Value = VSFGm.TextMatrix(VSFGm.Row, 1)
    frmV_RangoComi2.DTPicker2.Value = VSFGm.TextMatrix(VSFGm.Row, 2)
    frmV_RangoComi2.chkActivo.Value = VSFGm.TextMatrix(VSFGm.Row, 3)
    frmV_RangoComi2.Show
End Sub

Private Sub cmdNuevo_Click()
    frmV_RangoComi2.Tag = "N"
    frmV_RangoComi2.Show
End Sub

Private Sub Form_Activate()
    'Consulta todos los pedidos que pasan a bodega para ser revisados
    strSql = " SELECT ran_com_codigo,ran_com_fecha,ran_com_fechafin,ran_com_activo " & _
             " FROM rango_comi2 " & _
