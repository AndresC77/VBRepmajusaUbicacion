...
Begin VB.Form frmCargo 
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmCargo.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
End Sub
Private Sub Carga()
    strSql = " SELECT car_codigo,car_nombre,car_fechamod, car_usumod, '0' as modi " & _
             " FROM cargo " & _
             " WHERE emp_codigo = '" & strEmpresa & "'"
    If chkFiltroCodigo.value = 1 Then
        strSql = strSql & "AND  car_codigo LIKE  '%" & txtCodigo.Text & "%'"
    End If
        ...
        ElseIf VSFG.TextMatrix(i, VSFG.Cols - 1) = 2 Then
            ...
            Else
                ...
                If clsCon_Def.adorec_Def.RecordCount = 0 Then
                    ...
                    strSql = " INSERT INTO cargo(car_codigo,emp_codigo,car_nombre,car_fechamod,car_usumod) " & _
