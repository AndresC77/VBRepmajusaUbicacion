...
Begin VB.Form frmCanal 
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmCanal.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
End Sub
Private Sub Carga()
    strSql = " SELECT can_codigo,can_nombre,can_descripcion,can_fechamod, can_usumod, '0' as modi " & _
             " FROM canal " & _
             " WHERE emp_codigo = '" & strEmpresa & "'"
    If chkFiltroCodigo.value = 1 Then
        strSql = strSql & "AND  can_codigo LIKE  '%" & txtCodigo.Text & "%'"
    End If
    If chkFiltroNombre.value = 1 Then
        strSql = strSql & " AND  can_nombre LIKE '%" & txtNombre.Text & "%' "
    End If
    strSql = strSql & " ORDER BY can_nombre "
...
Private Sub cmbAceptar_Click()
    ...
    For i = 1 To VSFG.Rows - 1
        ...
        If VSFG.TextMatrix(i, VSFG.Cols - 1) = 3 Then
           strSql = " UPDATE canal " & _
                 " SET can_nombre='" & UCase(VSFG.TextMatrix(i, 2)) & "'," & _
                 " can_descripcion='" & UCase(VSFG.TextMatrix(i, 3)) & "'," & _
                 " can_fechamod=CURRENT_TIMESTAMP," & _
                 " can_usumod='" & strUsuario & "' " & _
                 " WHERE can_codigo='" & VSFG.TextMatrix(i, 1) & "' " & _
        ...
        ElseIf VSFG.TextMatrix(i, VSFG.Cols - 1) = 2 Then
            ...
            Else
                ...
                If clsCon_Def.adorec_Def.RecordCount = 0 Then
                    strSql = " INSERT INTO canal(can_codigo,emp_codigo,can_nombre,can_descripcion,can_fechamod,can_usumod) " & _
