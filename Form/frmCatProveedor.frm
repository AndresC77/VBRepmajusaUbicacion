...
Begin VB.Form frmCatProveedor 
   BackColor       =   &H00DDDDDD&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Categoria Proveedor"
   ClientHeight    =   6960
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8280
   Icon            =   "frmCatProveedor.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmCatProveedor.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmCatProveedor"
...
Private Sub IniDato()
    Tipo = "Categoría de Proveedores"
    Tipo2 = "el Categoría de Proveedores"
    Me.Caption = Tipo
End Sub
...
End Sub
Private Sub Carga()
    strSql = " SELECT cat_p_codigo,cat_p_nombre,cat_p_ctaconta,cat_p_ctaconta_ant,cat_p_fechamod, cat_p_usumod, '0' as modi " & _
             " FROM categoria_p  " & _
    ...
    strSql = " SELECT cta_codigo, CONCAT(cta_codigo,' - ',cta_nombre) as cta_nombre" & _
            ...
            " ORDER BY cta_codigo"
    clsCon_Def.Ejecutar strSql
    VSFG.ColComboList(3) = VSFG.BuildComboList(clsCon_Def.adorec_Def, " *cta_nombre", "cta_codigo")
    ...
    For i = 1 To VSFG.Rows - 1
        ...
        If VSFG.TextMatrix(i, VSFG.Cols - 1) = 3 Then
            strSql = " UPDATE categoria_p " & _
                     ...
                     " cat_p_ctaconta='" & UCase(VSFG.TextMatrix(i, 3)) & "'," & _
                     " cat_p_ctaconta_ant='" & UCase(VSFG.TextMatrix(i, 4)) & "'," & _
        ...
        ElseIf VSFG.TextMatrix(i, VSFG.Cols - 1) = 2 Then
            ...
            Else
                ...
                If clsCon_Def.adorec_Def.RecordCount = 0 Then
                    strSql = " INSERT INTO categoria_p(emp_codigo,cat_p_codigo,lis_pre_codigo," & _
                        " cat_p_nombre,cat_p_tipo,cat_p_ctaconta,cat_p_ctaconta_ant,cat_p_fechamod,cat_p_usumod) " & _
                        " VALUES ('" & strEmpresa & "','" & UCase(VSFG.TextMatrix(i, 1)) & "',NULL,'" & UCase(VSFG.TextMatrix(i, 2)) & "','P', " & _
                        " '" & UCase(VSFG.TextMatrix(i, 3)) & "','" & UCase(VSFG.TextMatrix(i, 4)) & "',CURRENT_TIMESTAMP, '" & strUsuario & "')"
                    clsCon_Def.Ejecutar strSql, "M"
                Else
