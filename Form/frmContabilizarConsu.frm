...
Begin VB.Form frmContabilizarConsu 
   BackColor       =   &H00DDDDDD&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Contabilizar Consumos"
   ClientHeight    =   6825
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10170
   Icon            =   "frmContabilizarConsu.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cmbDiaA 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":030A
            Left            =   3000
            List            =   "frmContabilizarConsu.frx":036B
            TabIndex        =   8
            Text            =   "DIA"
            Top             =   360
            Width           =   780
         ...
         Begin VB.ComboBox cmbMesA 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":03E2
            Left            =   2160
            List            =   "frmContabilizarConsu.frx":040D
            TabIndex        =   7
            Text            =   "MES"
            Top             =   360
            Width           =   780
         ...
         Begin VB.ComboBox cmbAñoA 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":044D
            Left            =   1320
            List            =   "frmContabilizarConsu.frx":04AE
            TabIndex        =   6
            Text            =   "AÑO"
            Top             =   360
            Width           =   780
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbDiaI 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":056C
            Left            =   3480
            List            =   "frmContabilizarConsu.frx":05CD
            TabIndex        =   2
            Text            =   "DIA"
            Top             =   240
            Width           =   780
         ...
         Begin VB.ComboBox cmbMesI 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":0644
            Left            =   2640
            List            =   "frmContabilizarConsu.frx":066F
            TabIndex        =   1
            Text            =   "MES"
            Top             =   240
            Width           =   780
         ...
         Begin VB.ComboBox cmbAñoI 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":06AF
            Left            =   1800
            List            =   "frmContabilizarConsu.frx":0710
            TabIndex        =   0
            Text            =   "AÑO"
            Top             =   240
            Width           =   780
         ...
         Begin VB.ComboBox cmbDiaF 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":07CE
            Left            =   3480
            List            =   "frmContabilizarConsu.frx":082F
            TabIndex        =   5
            Text            =   "DIA"
            Top             =   600
            Width           =   780
         ...
         Begin VB.ComboBox cmbMesF 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":08A6
            Left            =   2640
            List            =   "frmContabilizarConsu.frx":08D1
            TabIndex        =   4
            Text            =   "MES"
            Top             =   600
            Width           =   780
         ...
         Begin VB.ComboBox cmbAñoF 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "frmContabilizarConsu.frx":0911
            Left            =   1800
            List            =   "frmContabilizarConsu.frx":0972
            TabIndex        =   3
            Text            =   "AÑO"
            Top             =   600
            Width           =   780
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFGdb 
         ...
         FormatString    =   $"frmContabilizarConsu.frx":0A30
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
         ...
         AccessibleRole  =   24
      End
      Begin VSFlex8Ctl.VSFlexGrid VSFGConsumo 
         Height          =   1695
         Left            =   120
         TabIndex        =   9
         Top             =   1440
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmContabilizarConsu.frx":0ADC
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmContabilizarConsu"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'################################################################################'
'#  Forma para Contabilizar consumo de suministros y realizar su asiento        #
'#  frmContabilizarConsu V1.0                                                     #
'#  Copyright (C) 2002                                                          #
'#                                                                              #
'#  Ventana para ingresar el asiento de consumo de suministros                  #
'#                                                                              #
'#  Tablas que se maneja:                                                       #
'#  consumo: Esta tabla almacena los datos del consumo                          #
'#  det_consumo: Guarda los detalles del consumo de suministros                 #
'#  asiento: se almacena los asientos realizados por consumos                   #
'#  tipo de aisento: se almacena los detalles del asiento                       #                                                                              #
'#                                                                              #
'#  Objetos de la forma:                                                        #
...
Private clsAre As New clsConsulta
...
Private Sub PonerNumeros(Optional conBot As Boolean = True)
    For i = 1 To (VSFGConsumo.Rows - 1)
        VSFGConsumo.TextMatrix(i, 0) = i
    Next i
End Sub
Private Sub DebeHaber()
    ...
    VSFGdb.Clear 1
    VSFGdb.Rows = 1
    For k = 1 To (VSFGConsumo.Rows - 1)
        If VSFGConsumo.TextMatrix(k, 1) = -1 Then
        
            strSql = " SELECT are_ctaconta,cta_nombre,con_total,'0.00' as haber " & _
                    " FROM ((consumo " & _
                    " INNER JOIN  area " & _
                    " ON consumo.are_codigo = area.are_codigo " & _
                    " AND consumo.emp_codigo = area.emp_codigo ) " & _
                    " INNER JOIN ctaconta " & _
                    " ON area.emp_codigo = ctaconta.emp_codigo " & _
                    " AND area.are_ctaconta = ctaconta.cta_codigo) " & _
                    " WHERE consumo.emp_codigo = '" & strEmpresa & "' " & _
                    " AND consumo.con_codigo = '" & VSFGConsumo.TextMatrix(k, 2) & "' " & _
                    " AND consumo.con_numdoc = '" & VSFGConsumo.TextMatrix(k, 3) & "' "
            clsAre.Ejecutar (strSql)
                
        j = clsAre.adorec_Def.RecordCount
            If (clsAre.adorec_Def.RecordCount > 0) Then
            clsAre.adorec_Def.MoveFirst
            'Set VSFGdb.DataSource = clsAct.adorec_Def.DataSource
             ' For i = 1 To j
                    VSFGdb.Rows = VSFGdb.Rows + 1
                    VSFGdb.TextMatrix(VSFGdb.Rows - 1, 1) = clsAre.adorec_Def("are_ctaconta")
                    VSFGdb.TextMatrix(VSFGdb.Rows - 1, 2) = clsAre.adorec_Def("cta_nombre")
                    VSFGdb.TextMatrix(VSFGdb.Rows - 1, 3) = clsAre.adorec_Def("con_total")
                    VSFGdb.TextMatrix(VSFGdb.Rows - 1, 4) = clsAre.adorec_Def("haber")
            ' Next i
            End If
        
       
    strSql = " SELECT tip_sum_ctaconta,cta_nombre,'0.00' as deb,(det_con_cantidad*det_con_precio)as hab " & _
                " FROM ((((consumo " & _
                " INNER JOIN  det_consumo " & _
                " ON  consumo.con_codigo = det_consumo.con_codigo " & _
                " AND consumo.emp_codigo = det_consumo.emp_codigo ) " & _
                " INNER JOIN suministro " & _
                " ON  suministro.emp_codigo = det_consumo.emp_codigo " & _
                " AND suministro.sum_codigo = det_consumo.sum_codigo ) " & _
   ...
   'Ejectua el Selct con el rango de fechas deseado
    ...
    'If cmbDiaA.Tag <> "A" Then
        ...
        If (IsDate(fi)) = False Then
                MsgBox "La fecha de Inicio no es correcta", vbExclamation, "SisAdmi - Consumos Consumos "
            'cmbAñoI.SetFocus
              Exit Sub
        End If
        If (IsDate(ff)) = False Then
            MsgBox "La fecha de Fin no es correcta", vbExclamation, "SisAdmi - Contabilizar Consumos "
            'cmbAñoF.SetFocus
            Exit Sub
        End If
'    Else
...
'    End If
    If ff >= fi Then
    'llenar flexgrid
            strSql = " SELECT '0'as sel,con_codigo, con_numdoc,con_fecha, are_nombre,con_total,concat(substring(con_observacion,1,10),'...') as obs " & _
                     " FROM consumo " & _
                     " INNER JOIN  area " & _
                     " ON consumo.are_codigo = area.are_codigo " & _
                     " WHERE consumo.emp_codigo = '" & strEmpresa & "' " & _
        ...
        If (clscon.adorec_Def.RecordCount > 0) Then
            TxtTotal.Text = 0
            ban = 0
            Set VSFGConsumo.DataSource = clscon.adorec_Def.DataSource
            VSFGConsumo.ColDataType(1) = flexDTBoolean
            ban = 1
            Call PonerNumeros
            Call Cal_Total
        Else
            MsgBox "No hay Consumos ingresados en el sistema", vbExclamation, "SisAdmi - Contabilizar Consumos"
            Call limpiarFxGD
            TxtTotal.Text = ""
        End If
    Else
        MsgBox "La Fecha Fin es mayor que la Fecha Inicio, Verifiquela por Favor!", vbExclamation, "SisAdmi - Contabilizar Consumos"
        Exit Sub
    End If
...
Private Sub Cal_Total()
   'Calcula totales del grid de adquisicion
    ...
    Total = 0
    For i = 1 To VSFGConsumo.Rows - 1
        If VSFGConsumo.TextMatrix(i, 1) = -1 Then
            Total = Total + (Val(VSFGConsumo.TextMatrix(i, 6)))
         End If
    Next i
...
Private Sub cmdAceptar_Click()
    ...
    If (IsDate(fa) = False) Then
        MsgBox "La fecha de Asiento no es válida", vbInformation, "SisAdmi - Contabilizar Consumos"
        cmbAñoA.SetFocus
        Exit Sub
    End If
...
'        MsgBox "No esta cuadrado el Debe y el Haber", vbInformation, "SisAdmi - Contabilizar Consumos"
'    End If
        'Verificar que todos los datos se han llenado para ingresar en la base de datos
        If VSFGdb.TextMatrix(1, 1) = "" Then
            MsgBox "No estan ingresados todos los datos", vbInformation, "SisAdmi-Contabilizar Consumos"
            Exit Sub
            Else
            'Compacta la matriz
            ...
            Dim Des As String
            'Actualiza el campo con_asentado poniendo "1"
            For i = 1 To (VSFGConsumo.Rows - 1)
                If VSFGConsumo.TextMatrix(i, 1) = -1 Then
                    strSql = " UPDATE consumo " & _
                        " SET con_asentado = '1'" & _
                        " WHERE emp_codigo = '" & strEmpresa & "' " & _
                        " AND con_codigo = '" & VSFGConsumo.TextMatrix(i, 2) & "'"
                    clsSql.Ejecutar strSql, "M"
                Des = Des & VSFGConsumo.TextMatrix(i, 2) & "(" & VSFGConsumo.TextMatrix(i, 3) & ")/ "
                End If
            Next i
            'Inserta los datos en el asiento
            strSql = " INSERT INTO asiento (asi_numasiento, emp_codigo, asi_fecha, asi_revisado, asi_mayorizado, asi_totaldebe, asi_totalhaber, asi_descripcion, asi_fechamod, asi_usumod) " & _
                     " VALUES ('" & strMaximo & "','" & strEmpresa & "','" & fa & "', '0','0', '" & FormatoD2(txtTotalDebe) & "', '" & FormatoD2(txtTotalHaber) & "', '" & "ASIENTO DE CONSUMO DE SUMINISTRO(S):" & Des & "', CURRENT_TIMESTAMP, '" & strUsuario & "')"
            clsSql.Ejecutar strSql, "M"
            With VSFGdb
                For i = 1 To .Rows - 1
                    'Ingresa el detalle del asiento
                    ...
                    Else
                        strSql = " INSERT INTO det_asiento (emp_codigo, asi_numasiento, cta_codigo, det_asi_debe, det_asi_haber, det_asi_fechamod, det_asi_usumod) " & _
                                 " VALUES ('" & strEmpresa & "','" & strMaximo & "','" & .TextMatrix(i, 1) & "','" & FormatoD2(.TextMatrix(i, 3)) & "', '" & FormatoD2(.TextMatrix(i, 4)) & "' , CURRENT_TIMESTAMP, '" & strUsuario & "') "
                        clsSql.Ejecutar strSql, "M"
                    End If
                Next i
            End With
...
Private Sub Form_Load()
    ...
    clsAre.Inicializar AdoConn, AdoConnMaster
...
Private Sub VSFGdb_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    ...
    End If
End Sub
Private Sub VSFGConsumo_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
 If Col = 2 Or Col = 3 Or Col = 4 Or Col = 5 Or Col = 6 Or Col = 7 Then
    Cancel = True
    VSFGConsumo.Col = 1
  End If
End Sub
Private Sub VSFGConsumo_CellChanged(ByVal Row As Long, ByVal Col As Long)
    'este es el check box
    If ban = 1 Then
        If Col = 1 And Row > 0 Then
            If VSFGConsumo.TextMatrix(Row, 1) = "-1" Then
                VSFGConsumo.Select Row, 1, Row, 7
                VSFGConsumo.FillStyle = flexFillRepeat
                VSFGConsumo.CellBackColor = &HC0FFFF
                VSFGConsumo.Select Row, 7
            ElseIf VSFGConsumo.TextMatrix(Row, 1) = "0" Then
              VSFGConsumo.Select Row, 1, Row, 7
              VSFGConsumo.FillStyle = flexFillRepeat
              VSFGConsumo.CellBackColor = &HFFFFFF
              VSFGConsumo.Select Row, 7
            End If
        Call DebeHaber
        Call Cal_Total
