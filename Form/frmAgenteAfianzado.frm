...
'####################################################################################'
'#  Forma para el ingreso y modificación de Agentes Afianzados                       #
'#  frmAgenteAfianzado V1.0                                                          #
'#  Copyright (C) 2002                                                               #
'#                                                                                   #
'#  Ventana para el ingreso y modificación de Agentes Afianzados.                    #
'#  Permitirá almacenar en la base de datos nuevos Agentes y modificar sus           #
'#  nombres, dependiendo de la propiedad Tag, la cual se cambiará en la              #
'#  ventana frmSelAgenteAfianzado y desde esta se llamará a esta ventana.            #
'#                                                                                   #
