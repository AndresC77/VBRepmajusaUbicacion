...
Begin VB.Form frmVerAsiento 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cmbMesI 
            Height          =   315
            ItemData        =   "frmVerAsiento.frx":030A
            Left            =   1320
            List            =   "frmVerAsiento.frx":0335
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VSFlex8Ctl.VSFlexGrid VSFG 
         ...
         FormatString    =   $"frmVerAsiento.frx":039E
         ScrollTrack     =   0   'False
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Image imgBtnDn 
      Height          =   210
      Left            =   6120
      Picture         =   "frmVerAsiento.frx":04E3
      Top             =   0
      Visible         =   0   'False
      Width           =   225
   End
   Begin VB.Image imgBtnUp 
      Height          =   210
      Left            =   6360
      Picture         =   "frmVerAsiento.frx":060F
...
Public TipoVisualizacion As Boolean
...
Private Sub cmdModificar_Click()
    ...
    frmAsiento.Fecha1.Value = FechaAsiento
    ...
    For i = 1 To VSFG.Rows - 1
        ...
        frmAsiento.VSFG.TextMatrix(i, 5) = Me.VSFG.TextMatrix(i, 6)
...
Private Sub dcmbasiento_Change()
    If HacerConsulta = True Then
        ...
        Else
            cmdEliminar.Enabled = True
        End If
        If MesCerrado(FechaAsiento) Then
...
Private Sub Form_Activate()
    ...
    If TipoVisualizacion = True Then
...
Private Sub LlenarComboAsientos()
    ...
    dcmbAsiento = ""
    HacerConsulta = True
    strSQL = " SELECT (asiento.asi_numasiento) AS correlativo "
...
Private Sub LlenarDetalleAsiento()
    ...
    If clsSql.adorec_Def.RecordCount > 0 Then
        ...
        strSQL = " SELECT det_asiento.cta_codigo, cta_nombre, det_asi_debe, det_asi_haber,COALESCE(cen_cos_nombre,'') as cen_cos_nombre,det_asiento.cen_cos_codigo, det_asi_fechamod, det_asi_usumod,'0' as modi " & _
        ...
        ElHaber = 0
        For i = 1 To VSFG.Rows - 1
            If VSFG.TextMatrix(i, 3) <> 0 Or VSFG.TextMatrix(i, 4) <> 0 Then
