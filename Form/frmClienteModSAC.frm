...
Begin VB.Form frmClienteModSAC 
   BackColor       =   &H00DDDDDD&
   ...
   ClientTop       =   330
   ClientWidth     =   12285
   Icon            =   "frmClienteModSAC.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VSFlex8Ctl.VSFlexGrid VSFG 
      ...
      FormatString    =   $"frmClienteModSAC.frx":030A
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin VB.Image imgBtnUp 
      Height          =   240
      Left            =   5760
      Picture         =   "frmClienteModSAC.frx":0905
   ...
   End
End
Attribute VB_Name = "frmClienteModSAC"
...
Private Sub VSFG_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    ...
    ElseIf Val(VSFG.TextMatrix(Row, VSFG.Cols - 1)) = 3 Or Val(VSFG.TextMatrix(Row, VSFG.Cols - 1)) = -3 Then
        If Col = 1 Or Col = 3 Or Col = 7 Or Col = 8 Or (Col >= 21 And Col <= 28) Or (Col >= 32 And Col <= 43) Or Col >= VSFG.Cols - 5 Then
            Cancel = True
        End If
    End If
End Sub
